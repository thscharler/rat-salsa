...
use ratatui_crossterm::crossterm::event::{DisableBracketedPaste, DisableMouseCapture, EnableBracketedPaste, EnableMouseCapture, Event, KeyCode, KeyEvent, KeyEventKind, KeyModifiers};
#[cfg(not(windows))]
...
use ratatui_crossterm::{crossterm, CrosstermBackend};
