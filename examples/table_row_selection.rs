...
use rat_ftable::selection::{noselection, rowselection, RowSelection};
...
struct State {
    pub(crate) table: FTableState<RowSelection>,
...
fn repaint_table(frame: &mut Frame<'_>, area: Rect, data: &mut Data, state: &mut State) {
    ...
    let table1 = FTable::default()
        ...
        .select_row_style(Some(Style::default().bg(Color::Rgb(58, 58, 58))));
