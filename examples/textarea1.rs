...
fn repaint_input(
    ...
    // }
    // debug!("*** render stats width ***");
    // _ = writeln!(
    //     &mut stats,
    //     "width: {:?} ",
    //     state.textarea.line_width(state.textarea.cursor().y)
    // );
    // debug!("*** render stats next_word ***");
    // _ = writeln!(
    //     &mut stats,
    //     "next word: {:?} {:?}",
