...
pub const IMPERIAL: Palette = Palette {
    ...
    aliased: &[
        ...
        ("container-base", ColorIdx(Colors::Gray, 3)),
        ...
        ("disabled", ColorIdx(Colors::Gray, 7)),
        ("focus", ColorIdx(Colors::Primary, 1)),
        ("footer", ColorIdx(Colors::BlueGreen, 1)),
        ("footer-fg", ColorIdx(Colors::None, 0)),
        ("header", ColorIdx(Colors::BlueGreen, 1)),
        ...
        ("label", ColorIdx(Colors::TextDark, 4)),
        ("menu-base", ColorIdx(Colors::Gray, 2)),
        ...
        ("status-base", ColorIdx(Colors::Gray, 2)),
        ("text-focus", ColorIdx(Colors::Primary, 1)),
        ("text-select", ColorIdx(Colors::Secondary, 2)),
