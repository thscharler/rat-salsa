...
pub const MATERIAL: Palette = {
    ...
    p.color_ext[ColorsExt::DialogBorderFg as usize] = p.color[Colors::TextLight as usize][0];
    p.color_ext[ColorsExt::DialogArrowFg as usize] = p.color[Colors::TextLight as usize][0];
