...
pub const EVERFOREST: Palette = Palette {
    ...
    aliased: &[
        ...
        ("hover", ColorIdx(Colors::DeepBlue, 2)),
        ("input", ColorIdx(Colors::White, 1)),
        ...
        ("popup-arrow", ColorIdx(Colors::Gray, 1)),
        ("popup-base", ColorIdx(Colors::White, 3)),
        ("popup-border", ColorIdx(Colors::Gray, 1)),
