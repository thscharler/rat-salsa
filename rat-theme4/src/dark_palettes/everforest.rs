...
pub const EVERFOREST: Palette = {
    ...
    p.color_ext[ColorsExt::Input as usize] = p.color[Colors::White as usize][1];
    ...
    p.color_ext[ColorsExt::Hover as usize] = p.color[Colors::DeepBlue as usize][2];
    ...
    p.color_ext[ColorsExt::KeyBinding as usize] = p.color[Colors::Green as usize][0];
    ...
    p.color_ext[ColorsExt::PopupBase as usize] = p.color[Colors::White as usize][3];
    p.color_ext[ColorsExt::PopupBorderFg as usize] = p.color[Colors::Gray as usize][1];
    p.color_ext[ColorsExt::PopupArrowFg as usize] = p.color[Colors::Gray as usize][1];
