...
pub const SHELL: Palette = Palette {
    ...
    aliased: Cow::Borrowed(&[
        ...
        define_alias(Color::DOCUMENT_ARROW_FG, Colors::Gray, 0),
        define_alias(Color::DOCUMENT_BASE_BG, Colors::Black, 0),
        define_alias(Color::DOCUMENT_BORDER_FG, Colors::Gray, 0),
