...
pub const OXOCARBON: Palette = {
    let mut p = Palette {
        ...
        color: [
            Palette::interpolate2(0xdde1e6, 0xffffff, 0x0, 0x0),
            Palette::interpolate2(0x161616, 0x3c3c3c, 0x0, 0x0),
            Palette::interpolate(0x993560, 0xf7569c, DARKNESS),
            Palette::interpolate(0x464646, 0x5f5f5f, DARKNESS),
            Palette::interpolate(0xdde1e6, 0xffffff, DARKNESS),
            Palette::interpolate(0x161616, 0x3c3c3c, DARKNESS),
            Palette::interpolate(0x464646, 0x5f5f5f, DARKNESS),
            Palette::interpolate(0x993560, 0xf7569c, DARKNESS),
            Palette::interpolate(0x99755c, 0xf8bd96, DARKNESS),
            Palette::interpolate(0x998b6c, 0xfae3b0, DARKNESS),
            Palette::interpolate(0x2c8043, 0x2be665, DARKNESS),
            Palette::interpolate(0x05807d, 0x08bdba, DARKNESS),
            Palette::interpolate(0x4e7c99, 0x82cfff, DARKNESS),
            Palette::interpolate(0x24807e, 0x3ddbd9, DARKNESS),
            Palette::interpolate(0x1f6a99, 0x33b1ff, DARKNESS),
            Palette::interpolate(0x486599, 0x78a9ff, DARKNESS),
            Palette::interpolate(0x725999, 0xbe95ff, DARKNESS),
            Palette::interpolate(0x725999, 0xbe95ff, DARKNESS),
            Palette::interpolate(0x994c71, 0xff7ebd, DARKNESS),
        ],
