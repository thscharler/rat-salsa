...
pub const MONOCHROME: Palette = Palette {
    ...
    yellow: Palette::interpolate(0xefd7aa, 0xfffbf2, DARKNESS),
    limegreen: Palette::interpolate(0xdae09d, 0xf4f5e9, DARKNESS),
    green: Palette::interpolate(0xcdd489, 0xecede1, DARKNESS),
    bluegreen: Palette::interpolate(0x8ac3d4, 0xd5dee0, DARKNESS),
    cyan: Palette::interpolate(0x86b5d8, 0xd5dbe0, DARKNESS),
    blue: Palette::interpolate(0x93afc6, 0xd5dbe0, DARKNESS),
    deepblue: Palette::interpolate(0x91a5d6, 0xd3d6de, DARKNESS),
    purple: Palette::interpolate(0xccadd3, 0xded5e0, DARKNESS),
    magenta: Palette::interpolate(0xc7a4cf, 0xd7d0d8, DARKNESS),
