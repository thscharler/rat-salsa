...
pub const REDS: Palette = {
    let mut p = Palette {
        ...
        color: [
            ...
            Palette::interpolate2(0x301d1d, 0x704343, 0x0, 0x0),
            Palette::interpolate(0xff0000, 0xff8080, DARKNESS),
            Palette::interpolate(0xff4000, 0xff9f80, DARKNESS),
            Palette::interpolate(0xcfafaf, 0xe2cfcf, DARKNESS),
            Palette::interpolate(0x301d1d, 0x704343, DARKNESS),
