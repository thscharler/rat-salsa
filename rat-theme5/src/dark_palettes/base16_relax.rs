...
pub const BASE16_RELAX: Palette = {
    let mut p = Palette {
        ...
        color: [
            ...
            Palette::interpolate(0xff5555, 0xffb9b3, DARKNESS),
        ],
        color_ext: [Color::Reset; ColorsExt::LEN],
    };

    p.color_ext[ColorsExt::LabelFg as usize] = p.color[Colors::White as usize][1];
    ...
    p.color_ext[ColorsExt::Disabled as usize] = p.color[Colors::Gray as usize][1];
    p.color_ext[ColorsExt::Invalid as usize] = p.color[Colors::Red as usize][0];
    p.color_ext[ColorsExt::Hover as usize] = p.color[Colors::Cyan as usize][7];
    ...
    p.color_ext[ColorsExt::Shadows as usize] = p.color[Colors::Black as usize][2];
    ...
    p.color_ext[ColorsExt::ButtonBase as usize] = p.color[Colors::Gray as usize][3];
    p.color_ext[ColorsExt::MenuBase as usize] = p.color[Colors::Black as usize][1];
    p.color_ext[ColorsExt::KeyBinding as usize] = p.color[Colors::BlueGreen as usize][4];
    ...
    p.color_ext[ColorsExt::PopupBorderFg as usize] = p.color[Colors::Black as usize][1];
    p.color_ext[ColorsExt::PopupArrowFg as usize] = p.color[Colors::Black as usize][1];
    p.color_ext[ColorsExt::DialogBase as usize] = p.color[Colors::White as usize][1];
    p.color_ext[ColorsExt::DialogBorderFg as usize] = p.color[Colors::Black as usize][1];
    p.color_ext[ColorsExt::DialogArrowFg as usize] = p.color[Colors::Black as usize][1];
