...
pub const IMPERIAL: Palette = {
    ...
    p.color_ext[ColorsExt::Hover as usize] = p.color[Colors::Gray as usize][1];
    ...
    p.color_ext[ColorsExt::PopupBorderFg as usize] = p.color[Colors::Black as usize][3];
    p.color_ext[ColorsExt::PopupArrowFg as usize] = p.color[Colors::Black as usize][3];
